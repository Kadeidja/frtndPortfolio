...
export const aboutmeData = [
   {
       ...
       aboutmeimgsrc:'https://i.pinimg.com/564x/6f/d5/89/6fd589810a145b9068c15b75a511d048.jpg'
   },
   {
       aboutmeid: 1,
...
export const carrerPart = [
    {
        carrerid:0,
        carrername:'Front-End Developer',
        carreryears:['2000','2000'],
